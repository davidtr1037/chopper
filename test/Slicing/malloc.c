...
// RUN: FileCheck %s -input-file=%t.out -check-prefix=CHECK-RECOVERY
// RUN: FileCheck %s -input-file=%t.out -check-prefix=CHECK-SLICES
// RUN: FileCheck %s -input-file=%t.out -check-prefix=CHECK-SNAPSHOTS
